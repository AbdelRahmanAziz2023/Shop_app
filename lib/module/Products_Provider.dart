...
import 'package:shop/http_exceptoin.dart';
...
class Products with ChangeNotifier {
  ...
  void getData(String authToken, String userId, List<Product> products) {
  ...
  Future<void> fetchAndSetProducts([bool filterByUser = false]) async {
    ...
    var url =
        'https://shop-30bd5-default-rtdb.firebaseio.com/products.json?auth=$authToken&$filteredString';
    try {
      ...
      url =
      'https://shop-30bd5-default-rtdb.firebaseio.com/userFavorites/$userId.json?auth=$authToken';
  ...
  Future<void> addProduct(Product product) async {
    final url =
        'https://shop-30bd5-default-rtdb.firebaseio.com/products.json?auth=$authToken';
    try {
  ...
  Future<void> updateProduct(String id, Product newProduct) async {
    ...
    if (productIndex >= 0) {
      final url =
      'https://shop-30bd5-default-rtdb.firebaseio.com/products/$id.json?auth=$authToken';
      try {
